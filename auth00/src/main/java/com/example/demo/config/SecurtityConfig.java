    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/jsp/cart", "/jsp/orders", "/jsp/login", "/jsp/register").authenticated() // Require auth for these
...
//            }
    ...
    private LogoutSuccessHandler oidcLogoutSuccessHandler() {
        return (request, response, authentication) -> {
            String logoutUrl = "https://dev-0ay4k35zdc2pxrft.us.auth0.com/v2/logout?client_id=LaJZ8gqjAIc4DH1GJb5p0szK4evX4Vrq&returnTo=http://localhost:8080/logout";
